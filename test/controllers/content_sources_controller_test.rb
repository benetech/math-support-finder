...
class ContentSourcesControllerTest < ActionController::TestCase
  ...
  test "should create content_source" do
    assert_difference('ContentSource.count') do
      post :create, content_source: { description: @content_source.description, link: @content_source.link, title: @content_source.title, version: @content_source.version }
    end
  ...
  test "should update content_source" do
    patch :update, id: @content_source, content_source: { description: @content_source.description, link: @content_source.link, title: @content_source.title, version: @content_source.version }
    assert_redirected_to content_source_path(assigns(:content_source))
  end
