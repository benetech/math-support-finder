...
class PlatformsControllerTest < ActionController::TestCase
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post :create, platform: { description: @platform.description, link: @platform.link, title: @platform.title, version: @platform.version }
    end
  ...
  test "should update platform" do
    patch :update, id: @platform, platform: { description: @platform.description, link: @platform.link, title: @platform.title, version: @platform.version }
    assert_redirected_to platform_path(assigns(:platform))
  end
