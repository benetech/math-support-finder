...
class FormatsControllerTest < ActionController::TestCase
  ...
  test "should create format" do
    assert_difference('Format.count') do
      post :create, format: { description: @format.description, link: @format.link, title: @format.title, version: @format.version }
    end
  ...
  test "should update format" do
    patch :update, id: @format, format: { description: @format.description, link: @format.link, title: @format.title, version: @format.version }
    assert_redirected_to format_path(assigns(:format))
  end
