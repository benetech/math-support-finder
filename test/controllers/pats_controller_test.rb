...
class PatsControllerTest < ActionController::TestCase
  ...
  test "should create pat" do
    assert_difference('Pat.count') do
      post :create, pat: { assistive_technology_id: @pat.assistive_technology_id, platform_id: @pat.platform_id }
    end
  ...
  test "should update pat" do
    patch :update, id: @pat, pat: { assistive_technology_id: @pat.assistive_technology_id, platform_id: @pat.platform_id }
    assert_redirected_to pat_path(assigns(:pat))
  end
