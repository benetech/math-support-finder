...
class BrowserReader < ActiveRecord::Base
  ...
  has_many :file_formats, through: :browser_reader_file_formats, :after_remove => proc { |a| a.touch }

  has_many :browser_reader_renderers, dependent: :destroy
  has_many :renderers, through: :browser_reader_renderers, :after_remove => proc { |a| a.touch }

  has_many :platform_browser_readers, dependent: :destroy
  has_many :platforms, through: :platform_browser_readers, :after_remove => proc { |a| a.touch }

  has_many :browser_reader_assistive_technologies, dependent: :destroy
  has_many :assistive_technologies, through: :browser_reader_assistive_technologies, :after_remove => proc { |a| a.touch }
