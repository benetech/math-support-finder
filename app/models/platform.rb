...
class Platform < ActiveRecord::Base
  ...
  has_many :browser_readers, through: :platform_browser_readers, :after_remove => proc { |a| a.touch }

  has_many :platform_assistive_technologies, dependent: :destroy
  has_many :assistive_technologies, through: :platform_assistive_technologies , :after_remove => proc { |a| a.touch }
